...
app.layout = html.Div(children=[
    ...
    html.Div(children=[
        dcc.Graph(id='revenue-timeline-fig',  # id for callback
                  ...
                  style={'width': '47%', 'display': 'inline-block', 'padding': '0px 2px'}),  # Layout styling
        dcc.Graph(id='order-pie-fig',  # id for callback
                  figure=order_pie_fig,  # See figure above
                  style={'width': '47%', 'display': 'inline-block', 'padding': '0px 2x'})  # Layout styling
    ...
    html.Div(children=[
        ...
        dcc.Graph(id='bartender-order-completion-fig', figure=bartender_order_completion_fig,
                  style={'width': '47%', 'display': 'inline-block', 'padding': '0px 2px'})
    ], style={'width': '100%', 'display': 'inline-block'}),
